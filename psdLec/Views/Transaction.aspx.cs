    ...
    public partial class Transaction : System.Web.UI.Page
    {
        ...
        private void DisplayTransaction()
        {
            ...
            for (int i = 0; i < transactions.Count; i++)
            {
                ...
                table.Rows.Add(transactions[i].transaction_id.ToString(), product.product_name, product.product_price.ToString(), shipper.shipper_name, transactions[i].transaction_date.ToString("MM/dd/yyyy h:mm tt"), status);
            }
